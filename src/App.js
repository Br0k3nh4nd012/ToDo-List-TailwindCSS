...
class App extends React.Component {
  ...
  render() { 
    return ( 
      ...
      <div class="bg-yellow-400 h-auto">
        <h1 class="bg-yellow-400 text-center text-3xl m-auto mt-7 mb-7 rounded-xl max-w-2xl h-auto font-mono p-6 ">TODO LIST</h1>
  ...
  <div class="grid justify-items-center">
    ...
    <div class="justify-between space-x-2 bg">
        ...
        <button class="bg-yellow-50 h-11 px-5 rounded-md " type="submit">Add</button>
    </div>
    </form>
